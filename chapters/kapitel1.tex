...
The statistical uncertainty of $M_{\mathrm{BH}}$ is derived by propagating the $1\sigma$ errors of $\tau_{\mathrm{centroid}}$ (from the FR/RSS simulations; \cite{peterson1998}) and $\Delta V$:

\begin{equation}
	\left( \frac{\delta M_{\mathrm{BH}}}{M_{\mathrm{BH}}} \right)^2
	= \left( \frac{\delta \tau_{\mathrm{centroid}}}{\tau_{\mathrm{centroid}}} \right)^2
	+ \left( 2 \cdot \frac{\delta \Delta V}{\Delta V} \right)^2.
\end{equation}
Additional systematic uncertainties, mainly related to the choice of $f$, are typically of order a factor of 2 - 3 \parencite{peterson2004}.
