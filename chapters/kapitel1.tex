...
\textbf{Variability Abschnitt neu schreiben}

\subsection{Variability}
\label{sec:variability}

The variability of AGN is, if not even its most important feature, one of the key aspects that allows studying its central region, which generally cannot be measured with classical methods \parencite{Ulrich1997}. This stochastic variation can be observed on timescales from hours up to a few years over the whole electromagnetic spectrum and is wavelength dependent. Thus, high-energy emission, like X-rays, shows stronger variation than optical or infrared emission. These variations appear in flux as well as in the line profiles of broad emission lines. While the variations are stochastic, there are measurable correlations between different spectral features of the AGN spectrum, for example between different broad emission lines or between line and continuum emission \parencite{Ulrich1997, Peterson_1999}. This correlation on such small time scales can be utilized for reverberation mapping (see Chapter \ref{sec:reverberation_mapping}) to obtain information about the size and structure of the emitting regions and the mass of the SMBH \parencite{peterson1997introduction, Ulrich1997}.\\
