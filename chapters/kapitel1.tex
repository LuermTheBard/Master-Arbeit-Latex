...
\begin{figure}[!ht]
	...
	\caption[Comparison of Seyfert I and Seyfert II spectra]{An example of Seyfert I and Seyfert II spectra illustrating their differences. Broad lines, such as  H$\alpha$ and H$\beta$, are only present in the Seyfert I spectrum, whereas forbidden [O III] lines are visible in both cases. Adapted from \cite{keel2002quasars}.}
