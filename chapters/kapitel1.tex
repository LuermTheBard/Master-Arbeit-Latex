...
This intrinsic variability plays a central role in reverberation mapping. Continuum fluctuations from the accretion disk serve as a variable ionizing source, illuminating the surrounding BLR. The emission-line response follows these continuum variations with a measurable time delay corresponding to the light-travel distance between the continuum source and the BLR clouds. By monitoring these delays, the geometry and size of the BLR can be determined, providing direct insights into the inner structure of AGNs and enabling black hole mass estimates \parencite{Cackett2021}.
