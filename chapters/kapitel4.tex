...
The analysis of the line profiles yielded a FWHM of $4556\pm350$ for Ly$\alpha$, $3383 \pm 1000$ for N\,\textsc{v}$\,\lambda\lambda 1238,\,1242$, $10005 \pm 1000$ for Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$ and $8428 \pm 500$ for C\textsc{iv}$\,\lambda\lambda 1548,\,1550$. It has to be noted that the FWHM of the  N\,\textsc{v}$\,\lambda\lambda 1238,\,1242$ profile has been estimated based on its red flank, as it is blended with the Ly$\alpha$ profile.
The RMS line profile of Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$ has been excluded from the further analysis, due to its noise and possible overlap with O\,\textsc{iv}] emission. 
