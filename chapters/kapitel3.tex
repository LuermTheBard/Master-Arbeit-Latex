...
Figure \ref{fig:line_profiles_balmer} shows an overlay of the AVG (black) and RMS (red) line profiles of the Balmer lines H$\alpha$, H$\beta$ and H$\gamma$. All three lines shows narrow line components additional to the broad line component, which makes a comparison of the AVG line profile inconclusive.\\
\begin{figure}[!ht]
	\centering
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.8\textwidth]{pictures/Chapter4/line_profiles/RMS_overlay_Balmer.pdf}
	\caption{AVG RMS Spektrum}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\textwidth]{pictures/Chapter4/line_profiles/Normalized_Helium_Line_Profiles.pdf}
...
\subsection{Ly$\alpha$ and OI$\,\lambda 8446$}
\begin{figure}[!ht]
	\centering
	\includegraphics[width=\textwidth]{pictures/Chapter4/line_profiles/Normalized_Lyman_and_Oxygen_Line_Profiles.pdf}
	\caption{A plot of the AVG and RMS line profiles of the broad emission lines  Ly$\alpha$ and OI$\,\lambda 8446$ .}
	\label{fig:line_profiles_Ly_O}
\end{figure}
