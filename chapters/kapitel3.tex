...
The mean and rms profiles of all emission lines exhibit asymmetric shapes. In the mean profiles, H$\alpha$, H$\beta$, H$\delta$ and He\,\textsc{i}$\,\lambda5875$ display more extended red wings. The red wing of H$\gamma$ is blended with [O\,\textsc{iii}] $\lambda4363$, however, as a Balmer line, its profile is expected to follow a similar shape to the other Balmer lines, but cannot be verified. Ly$\alpha$ shows absorption in the blue wing of its mean profile and is blended with N\,\textsc{v}$\,\lambda\lambda 1283,\,1242$ in the red wing, yet a tendency towards red-wing asymmetry remains noticeable. In contrast, the high-ionization UV lines Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$ and C\,\textsc{iv}$\,\lambda\lambda 1548,\,1550$ and He\,\textsc{ii}$\,\lambda1640$ display broader blue wings in their mean profiles. Been also a helium\,\textsc{ii} line, a similar blue-wing asymmetry would be expected for He\,\textsc{ii}$\,\lambda4685$, but can not be identified due to the blend with a Fe\,\textsc{ii} band in the blue wing. The same applies to  N\,\textsc{v}$\,\lambda\lambda 1283,\,1242$, whose mean profile is mostly blended in the mean profile of Ly$\alpha$. \\
Like the mean profiles, the rms profiles display a comparable asymmetric behavior. The rms profiles of the Balmer lines share an overall similar asymmetric double-peaked shape, with the blue peak exhibiting higher flux (see Figure \ref{fig:rms_Balmer}). The two peaks of the profiles are consistently located at around $\sim 500\,\mathrm{km\,s^{-1}}$ and $\sim 2000\,\mathrm{km\,s^{-1}}$ for all Balmer lines, resulting in a shift of the rms profiles towards positive velocities. This shift is also present in the rms profile of Ly$\alpha$, which exhibits absorption in both wings in addtion to the blend with the N\,\textsc{v}$\,\lambda\lambda 1283,\,1242$ profile. While the profiles of H$\alpha$ and H$\beta$ show similarly steep slopes in both wings, those of H$\gamma$ and H$\delta$ display more extended blue wings. This leads to a mutual resemblance between the rms profiles of H$\alpha$ and H$\beta$, and between H$\gamma$ and H$\delta$.\\
The peak of the rms profile of He\,\textsc{i}$\,\lambda5875$ is likewise shifted towards positive velocities, at approximately $\sim 1500\,\mathrm{km\,s^{-1}}$, but shows a more blue-weighted shape with and broader blue wing. A similar asymmetry is seen in the rms profile of He\,\textsc{ii}$\,\lambda4685$ (see Figure \ref{fig:rms_Helium}). In contrast to He\,\textsc{i}$\,\lambda5875$, the peak of the He\,\textsc{ii}$\,\lambda4685$ rms profile shows no velocity shift, and a much broader blue wing, which results in a broader overall line width. The rms profile of He\,\textsc{ii}$\,\lambda1640$ is less pronounced and blended with the rms profile of the semi-forbidden doublet O\,\textsc{iii}]$\lambda\lambda\,1660,1666$. Still its shape is comparable to the He\,\textsc{ii}$\,\lambda4685$ rms profile shape with no velocity shift and broader blue wing. \\
Due to blending with the Ly$\alpha$ rms profile and the presence of absorption, the rms profile of N\,\textsc{v}$\,\lambda\lambda 1283,\,1242$ cannot be extracted (see Figure \ref{fig:emission_line_lightcurves}). The rms profiles of  Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$ and C\,\textsc{iv}$\,\lambda\lambda 1548,\,1550$ both display broad line widths with extended blue wings, comparable to those of the He\,\textsc{ii} lines. Here it has to be noted, that Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$ is blended with the semi-forbidden doublet O\textsc{IV}]$\,\lambda\lambda\,1397,\,1400$, which cannot be resolved from the line profile. The C\textsc{iv}$\,\lambda\lambda 1548,\,1550$ rms profile shows a two peak profile, which is caused by absorption close center of the profile.\\
...
The mean profile of the NIR emission line O\,\textsc{i}$\,\lambda 8446$  is blended with the Ca\,\textsc{ii} O\,\textsc{i}$\,\lambda 8446$$\lambda8498$, $\lambda8542$, $\lambda8662$ triplet. A decomposition of the O\,\textsc{i}$\,\lambda 8446$ line profile was already performed by \cite{Ochmann_2025} based on a MUSE campaign in 2019, and was therefore not attempted here. Although O\,\textsc{i}$\,\lambda 8446$ shows variability in the rms spectrum, its profile is too noisy for a reliable FWHM measurement due to the low signal-to-noise ratio.\\
As mentioned in the previously section, the N\,\textsc{v}$\,\lambda\lambda 1283,\,1242 $ is blended with the Ly$\alpha$ profile in both mean and rms and exhibits not resolved absorption in its blue wing in the rms spectrum, making it difficult to estimate the FWHM for the N\,\textsc{v}$\,\lambda\lambda 1283,\,1242 $ profiles. Using the same approach as for the mean profile of He\,\textsc{ii}$\,\lambda4685$, the width of the rms profiles red wing was measured and doublet. \\
