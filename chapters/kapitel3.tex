...
\begin{table}[!htb]
	...
	\begin{tabular}{l c c c}
		...
		\hline
		H$\alpha$ & $3.5 \ensuremath{_{-0.9}^{+0.8}}$ & $2.0 \ensuremath{_{0.5}^{+3.0}}$ & $1.2 \ensuremath{_{-0.4}^{+0.5}}$ \\
		H$\beta$ & $2.3 \ensuremath{_{-0.3}^{+1.0}}$ & $2.0 \ensuremath{_{0.0}^{+1.0}}$ & $0.9 \ensuremath{_{-0.2}^{+0.6}}$ \\
		H$\gamma$ & $1.7 \ensuremath{_{-0.4}^{+0.2}}$ & $2.0 \ensuremath{_{-1.0}^{+0.0}}$ & $0.9 \ensuremath{_{-0.3}^{+0.3}}$ \\
		He\,\textsc{i}\,5875 & $3.3 \ensuremath{_{-0.4}^{+0.7}}$ & $3.0 \ensuremath{_{0.0}^{+1.5}}$ & $1.7 \ensuremath{_{-0.4}^{+0.7}}$ \\
		He\,\textsc{ii}\,4685 & $0.7 \ensuremath{_{-0.3}^{+0.1}}$ & $1.0 \ensuremath{_{-0.5}^{+0.0}}$ & $0.9 \ensuremath{_{-0.4}^{+0.2}}$ \\
		O\,\textsc{i}\,8446 & $5.0 \ensuremath{_{-1.7}^{+2.0}}$ & $6.0 \ensuremath{_{-3.0}^{+1.5}}$ & - \\
		\hline
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[!htb]
	...
	\begin{tabular}{l c c c}
		...
		Name & $\tau_{\text{cent}}$ [d] & $\tau_{\text{peak}}$ [d] & $M_{\text{BH}} [10^7 M_\odot]$ \\
		\hline
		Ly$\alpha$ & $1.0 \ensuremath{_{-0.2}^{+0.4}}$ & $1.0 \ensuremath{_{-0.5}^{+0.0}}$ & $0.6 \ensuremath{_{-0.1}^{+0.2}}$ \\
		Si\,\textsc{iv}\,1393 & $1.2 \ensuremath{_{-0.4}^{+0.1}}$ & $2.0 \ensuremath{_{-1.0}^{+-0.5}}$ & $3.6 \ensuremath{_{-1.2}^{+0.3}}$ \\
		N\,\textsc{v}\,1238 & $1.0 \ensuremath{_{-0.4}^{+0.2}}$ & $1.0 \ensuremath{_{-0.5}^{+0.0}}$ & $0.4 \ensuremath{_{-0.1}^{+0.1}}$ \\
		C\,\textsc{iv}\,1548 & $0.8 \ensuremath{_{-0.0}^{+0.5}}$ & $1.0 \ensuremath{_{-0.5}^{+0.1}}$ & $1.5 \ensuremath{_{-0.0}^{+1.0}}$ \\
		He\,\textsc{ii}\,1640 & $0.3 \ensuremath{_{-0.2}^{+0.6}}$ & $0.0 \ensuremath{_{0.0}^{+1.0}}$ & $0.4 \ensuremath{_{-0.3}^{+1.0}}$ \\
		\hline
		\hline
	\end{tabular}
\end{table}
