...
The AVG spectrum shows narrow emission lines, as well as broad emission lines, which is expected due to the Seyfert 1 classification of NGC 4593. The first part of the reverberation mapping analysis is now the determination of Lines in the optical part of the spectrum (\ref{fig:AVG_RMS_SPECTRUM}) and the UV part between 1100 and 1700 $\AA$ (\ref{fig:UV_uncalibrated_AVG_RMS}). 
\begin{figure}[!htbp]
	\centering
	\makebox[\textwidth][c]{%
