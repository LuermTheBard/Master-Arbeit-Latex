...
Thanks to the covered wavelength range, it was possible to measure several continuum lightcurves in the UV-, optical- and NIR regime. In addition, the photometric UVOT UVW2 lightcurve is included in the subsequent analysis, which was taken with \textit{Swift} (PI: McHardy, I.M., Prop...) and published in \cite{mchardy2018x}. It  has also been used in \cite{cackett2018accretion} and exhibits a denser sampling than the HST lightcurves, with a cadence of 96 minutes for $6.4\,\mathrm{d}$ between July 13 and July 18, 2016 and a central wavelength of about $\sim 1930\,\AA$ \parencite{mchardy2018x}.\\ 
...
\begin{table}[htbp]
	...
	\begin{tabular}{l c | l c}
		...
		\hline\hline
		H$\alpha$             & $3.3 \ensuremath{_{-0.6}^{+1.1}}$ & He\,\textsc{i}\,5875   & $3.3 \ensuremath{_{-0.4}^{+0.7}}$ \\
		...
		O\,\textsc{i}\,8446   & $4.7 \ensuremath{_{-1.4}^{+2.4}}$ &  C\textsc{iv}$\,\lambda\lambda 1548,\,1550$   & $0.8 \ensuremath{_{-0.1}^{+0.5}}$ \\
		\hline\hline
	\end{tabular}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{lcc}
		...
		\hline
		\hline
		H$\alpha$  & $3000 \pm 250$ &  $3100\pm 250$\\
		H$\beta$ & $3400 \pm 200$&  $3400 \pm 200$ \\
		H$\gamma$ & $4100 \pm 200$&  $3900 \pm 400$ \\
		H$\delta$ & $3400 \pm 250$&  $5900 \pm 1000$ \\
		Ly$\alpha$ & $3800 \pm 350$  &  $4600\pm 500$\\
		\hline
		He\,\textsc{i}$\,\lambda5875$ & $3500 \pm 300$&  $4000 \pm 400$  \\
		He\,\textsc{ii}$\,\lambda1640$  & $2900 \pm 500$ & $6900 \pm 1000$\\
		He\,\textsc{ii}$\,\lambda4685$&  $1800 \pm 600$&  $6000 \pm 400$ \\
		
		\hline
		N\,\textsc{v}$\,\lambda\lambda 1238,\,1242$ &  $3200 \pm 800$&  $3400 \pm 1000$\\
...
\begin{table}[htbp]
	...
	\begin{tabular}{lc}
		...
		H$\beta$ &  $3400 \pm 200$ \\
		H$\gamma$ &  $3900 \pm 400$ \\
		H$\delta$ &   $5900 \pm 1000$ \\
		Ly$\alpha$ &   $4600\pm 500$\\
		\hline
		He\,\textsc{i}$\,\lambda5875$&  $4000 \pm 400$  \\
		He\,\textsc{ii}$\,\lambda1640$  &  $6900 \pm 1000$\\
		He\,\textsc{ii}$\,\lambda4685$&    $6000 \pm 400$ \\
		
		\hline
		N\,\textsc{v}$\,\lambda\lambda 1238,\,1242$ &  $3400 \pm 1000$\\
...
\end{figure}\\
Looking in more detail into the shape of RMS profiles, the H$\alpha$ and H$\beta$ profiles show a strong similarity to each other, with both wings exhibiting a steep slope. The red wing of the H$\gamma$ and H$\delta$ profiles follows the same slope, which ends in a small peak at about $\sim 3000 \,\mathrm{km\,s^{-1}}$. The H$\gamma$ and H$\delta$ profiles show a more extended blue wing. The H$\delta$ profile is the most noisy of the Balmer RMS profiles. Still a close similarity to the H$\gamma$ profile is noticeable, showing the same broad blue wing. This also leads to higher FWHM value of  $\sim 3900 \pm 400\,\mathrm{km\,s^{-1}}$ for H$\gamma$ and $\sim 5900 \pm 1000 \,\mathrm{km\,s^{-1}}$ for H$\delta$ compared to the values of H$\alpha$ and H$\beta$ with $\sim 3100 \pm 250\,\mathrm{km\,s^{-1}}$ and $\sim 3400 \pm 200\,\mathrm{km\,s^{-1}}$. Taking the similarities of the RMS profile shapes, it can be assumed that all four Balmer lines emerge under similar kinematic properties. \\
Looking at Figure \ref{fig:line_profiles} it can be seen, that most of the RMS profile is located within the red wing of the AVG profiles, suggesting that a largely part of the measured variation originates at positive velocities of the emitting region. 
...
\end{figure}\\
A similar shape can be noticed for the RMS profile of He\,\textsc{ii}$\,\lambda4685$. While its profile is not shifted, like for He\,\textsc{i}$\,\lambda5875$, it also shows a more extended blue wing and narrow red wing, with a FWHM of about $6000 \pm 400 \,\mathrm{km\,s^{-1}}$.\\
The RMS profile of the UV Helium line He\,\textsc{ii}$\,\lambda1640$ is even more noisy, compared to the RMS profiles of the other Helium lines due to its lower signal to noise ratio. Like the He\,\textsc{ii}$\,\lambda4685$ RMS profile its maximum is located somewhere around $0\,\mathrm{km\,s^{-1}}$ and also exhibits a more extended blue wing and a steep slope in its red wing. At around $2000\,\mathrm{km\,s^{-1}}$ its RMS profile is blended with the RMS profile of semi-forbidden doublet O\,\textsc{iii}]$\,\lambda\lambda 1660,\,1666$. Still, its contribution to the RMS profile of He\,\textsc{ii}$\,\lambda1640$ stays below the half height of the profile and does not influence the FWHM measurement with a value of about $6900 \pm 1000\,\mathrm{km\,s^{-1}}$.\\
Comparing the RMS profiles of the He lines, all three show a similar shape with a extended blue wing and a narrow red wing, with He\,\textsc{i}$\,\lambda5875$ exhibiting a narrower FWHM and a shift towards positive velocities, than the He\,\textsc{ii} RMS profiles, who shows FWHM in the same order of magnitude. 
...
\begin{table}[htp]
	...
	\begin{tabular}{l c c c}
		...
		\hline
		\hline
		Ly$\alpha$ & $1.0 \ensuremath{_{-0.2}^{+0.4}}$ & $4600 \pm 500$ &$0.7 \ensuremath{_{-0.2}^{+0.3}}$ \\
		H$\alpha$ & $3.2 \ensuremath{_{-0.6}^{+1.0}}$ & $3100 \pm 250$ &$1.1 \ensuremath{_{-0.4}^{+0.6}}$ \\
		H$\beta$ & $2.3 \ensuremath{_{-0.3}^{+1.0}}$ & $3400 \pm 200$&$0.9 \ensuremath{_{-0.2}^{+0.6}}$ \\
		H$\gamma$ & $1.7 \ensuremath{_{-0.4}^{+0.2}}$ & $3900 \pm 300$ &$0.9 \ensuremath{_{-0.3}^{+0.3}}$ \\
		H$\delta$ & $1.7 \ensuremath{_{-0.4}^{+0.4}}$ & $5900 \pm 1000$  & $1.5 \ensuremath{_{-0.5}^{+0.6}}$ \\
		He\,\textsc{i}$\,\lambda5876$ & $3.3 \ensuremath{_{-0.4}^{+0.7}}$ & $ 4000 \pm 300$&$1.8 \ensuremath{_{-0.5}^{+0.7}}$ \\
		He\,\textsc{ii}$\,\lambda1640$ & $0.3 \ensuremath{_{-0.2}^{+0.6}}$ & $6900 \pm 1000$ & $0.4 \ensuremath{_{-0.3}^{+1.2}}$ \\
		He\,\textsc{ii}$\,\lambda4686$ & $0.7 \ensuremath{_{-0.3}^{+0.1}}$ & $6000 \pm 300$ &$0.9 \ensuremath{_{-0.4}^{+0.2}}$ \\
		C\,\textsc{iv}$\,\lambda\lambda 1548,\,1550$ & $0.8 \ensuremath{_{-0.1}^{+0.5}}$ & $8400 \pm 1000$ &$1.9 \ensuremath{_{-0.2}^{+1.7}}$ \\
