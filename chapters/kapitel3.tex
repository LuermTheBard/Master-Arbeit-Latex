...
With this method, the FWHM of the Balmer line profiles, the Ly$\alpha$ line profile, the He\,\textsc{i}$\,\lambda5875$ line profile, and the C\,\textsc{iv}$\,\lambda\lambda 1548,\,1550$ doublet profile are measured in both the AVG and RMS spectra. In addition, the FWHM is measured only from the RMS profile of He\,\textsc{ii}$\,\lambda4685$ and only from the AVG profile of He\,\textsc{ii}$\,\lambda1640$. All measurements are performed with GECHO.\\
The FWHM of the AVG profile of He\,\textsc{ii}$\,\lambda4685$ is estimated by doubling the width of its red flank, as the blue flank is blended by the Fe\,\textsc{ii} band between $4489\,\AA$ and $4629\,\AA$. The same approach is used for the N\,\textsc{V}$\,\lambda\lambda 1238,\,1242$ doublet in the AVG and RMS spectra, as it is blended with the Ly$\alpha$ profile. The FWHM of the RMS profile of He\,\textsc{ii}$\,\lambda1640$ has to be estimated by doubling the width of its blue flank, as it is blended with the O\,\textsc{iii}]$\,\lambda\lambda 1660,\,1666$ doublet.\\
Finally, the FWHM measurements for O\,\textsc{i}$\,\lambda 8446$ and Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$ are excluded from the subsequent analysis. The RMS profile of O\,\textsc{i}$\,\lambda 8446$ is too noisy for a line width estimation, and for Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$ the overlapping doublet components together with additional semi-forbidden O\,\textsc{iv}] emission prevent a reliable FWHM estimate from the RMS spectrum. The resulting FWHM values are listed in Table \ref{tab:line_width_FWHM}.
\begin{table}[!ht]
	\centering
	\small
...
By using Equation \ref{eqn:velocity_space} together with the rest-frame central wavelengths of the emission lines, this corresponds to an equivalent dispersion per pixel in velocity space, listed in Table \ref{tab:grating_dispersion}. This dispersion is used as a minimum estimate for the uncertainty estimation. The FWHM uncertainties of the RMS profiles of H$\gamma$, H$\delta$, He\,\textsc{i}$\,\lambda5875$, and He\,\textsc{ii}$\,\lambda4685$ are scaled up due to their profile shape and noise.\\
Higher uncertainties are also adopted for Ly$\alpha$, as it is blended with absorption in its blue flank and with the N\,\textsc{iv}$\,\lambda\lambda 1238,\,1242$ doublet in its red flank, and for the C\textsc{iv}$\,\lambda\lambda 1548,\,1550$ doublet, as it shows a strongly asymmetric profile. Finally, the uncertainties for the AVG and RMS profiles of He\,\textsc{ii}$\,\lambda1640$, N\,\textsc{v}$\,\lambda\lambda 1238,\,1242$, and for the AVG profile of He\,\textsc{ii}$\,\lambda4685$ are set significantly higher, since they are estimated from the width of only one flank.
