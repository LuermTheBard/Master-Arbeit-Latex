...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/line_profiles/Normalized_Line_Profiles_Balmer.pdf}
	\caption{A plot of the AVG and RMS line profiles of the broad emission lines H$\alpha$, H$\beta$, H$\gamma$ and H$\delta$.}
	\label{fig:line_profiles_balmer}
\end{figure}
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/line_profiles/Normalized_Line_Profiles_He_O.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/line_profiles/Normalized_Line_Profiles_UV.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/line_profiles/AVG_overlay_Balmer.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/line_profiles/RMS_overlay_Balmer.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/line_profiles/AVG_overlay_Helium.pdf}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/line_profiles/RMS_overlay_Helium.pdf}
	\caption{Comparison of the AVG and RMS line profiles of the Helium lines HeI$\,\lambda5875$ vs HeII$\,\lambda$4685.}
...
\begin{table}[!ht]
	...
	\begin{tabular}{l c c c}
		\hline
		\hline
		Name & $\tau_{\text{cent}}$ [d] & \textbf{FWHM RMS[km/s]} & $M_{\text{BH}} [10^7 M_\odot]$ \\
		\hline
		...
		He\,\textsc{i}$\,\lambda5875$ & $3.3 \ensuremath{_{-0.4}^{+0.7}}$ & $ 3952 \pm 300$&$1.8 \ensuremath{_{-0.5}^{+0.7}}$ \\
		He\,\textsc{ii}$\,\lambda1640$ & $0.3 \ensuremath{_{-0.2}^{+0.6}}$ & $7459 \pm 200$ &$0.5 \ensuremath{_{-0.3}^{+1.2}}$ \\
		He\,\textsc{ii}$\,\lambda4685$ & $0.7 \ensuremath{_{-0.3}^{+0.1}}$ & $5972 \pm 300$ &$0.9 \ensuremath{_{-0.4}^{+0.2}}$ \\
