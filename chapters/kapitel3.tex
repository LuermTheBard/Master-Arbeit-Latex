...
Balmer lines and Helium lines in the optical range are commonly used in a lot of reverberation mapping campaigns, as they are easy to access for nearby AGN \parencite{ochmann2026first}. Other lines, like the low-ionization line, O\,\textsc{i}$\,\lambda 8446$ has not been of huge interests in such campaigns, mostly because of observational limitations \parencite{ochmann2026first}. Which is why the variation of the O\,\textsc{i}$\,\lambda 8446$ line in this campaign is of particular interests, as the line can get enhanced by Bowen fluorescence, pumped by Ly$\beta$ emission \parencite{grandi1980}. By analyzing the time lags of the participating transitions, it is possible to estimate the location of the emission region of the O\,\textsc{i}$\,\lambda 8446$ emission line relatively to other emitting regions. If O\,\textsc{i}$\,\lambda 8446$ originates in a well-defined region, the time delay between the ionizing continuum and O\,\textsc{i}$\,\lambda 8446$ should be consistent with a causal chain in which continuum
variations drive Ly$\beta$ variations, which in turn drive part of the O\,\textsc{i}$\,\lambda 8446$ response. Unfortunately, Ly$\beta$ lies outside of the spectral range of the \cite{cackett2018accretion} campaign. But because it is expected that the Ly$\alpha$ and Ly$\beta$ lines originate under similar physical conditions \parencite{ochmann2026first}, Ly$\alpha$ can be used as a proxy for Ly$\beta$. H$\alpha$ is used to investigate the location of the O\,\textsc{i}$\,\lambda 8446$ emitting region relative to the emitting region of the Balmer lines.\\
Therefore the time lags between the UVW2 and emission lines lightcurves, the CCFs and time lags between O\,\textsc{i}$\,\lambda 8446$ and Ly$\alpha$, between H$\alpha$ and Ly$\alpha$ and O\,\textsc{i}$\,\lambda 8446$ and H$\alpha$ are calculated, which are shown in Figure \ref{fig:ccfs_Bowen}. All lightcurve show a strong correlation between $\approx 0.75 - 0.8$, with exception for the O\,\textsc{i}$\,\lambda 8446$ and UVW2 lightcurve that only shows a maximal correlation of $0.6$. The time lag and uncertainties gets calculated like before. O\,\textsc{i}$\,\lambda 8446$ lags behind Ly$\alpha$ with $2.5 \ensuremath{_{-0.4}^{+1.8}}$ days and behind UVW2 with $5.0 \ensuremath{_{-1.7}^{+2.1}}$ days, while H$\alpha$ lags behind Ly$\alpha$ with $1.8 \ensuremath{_{-0.5}^{+0.5}}$ days and behind UVW2 with $3.3 \ensuremath{_{-0.7}^{+1.0}}$ days. A difference in the responding time of about $0.5-1$ days between O\,\textsc{i}$\,\lambda 8446$ H$\alpha$ is noticeable, but are not significant within the uncertainties. Looking now at the lightcurves of O\,\textsc{i}$\,\lambda 8446$ and H$\alpha$, they show a strong correlation as well with O\,\textsc{i}$\,\lambda 8446$ lagging behind H$\alpha$ by about $0.3 \ensuremath{_{-0.1}^{+2.0}}$ day. Finally the lightcurve of Ly$\alpha$ lags behind the UVW2 lightcurve by $1.1 \ensuremath{_{-0.2}^{+0.4}}$ days.
\begin{figure}[!ht]
	\centering
...
\end{equation}
As describes in Section \ref{subsec:BHM}, the line width used to describe the velocity dispersion $\Delta V^2$ of the broad emission line. For this analysis, the line width gets measured using the FWHM of the RMS line profile, to only measure the broad line component of the emission line. Following \cite{probst2025emissionlinecontinuumreverberationmapping} a scale factor of $f =1.8$ is adopted, which accounts the ratio of the FWHM and line dispersion $\mathrm{FWHM}/\sigma_\mathrm{line} \approx 2$ estimated by \cite{peterson2004}. The resulting SMBH mass results, as well as the corresponding time lag and FWHM values of the broad emission lines are listed in Table \ref{tab:BH_mass}. 
...
\begin{table}[!ht]
	...
	\begin{tabular}{l c c c}
		...
		Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$  & $1.2 \ensuremath{_{-0.4}^{+0.1}}$ & $10005 \pm 300$ &$4.4 \ensuremath{_{-1.7}^{+0.8}}$ \\
		C\,\textsc{iv}$\,\lambda\lambda 1548,\,1550$ & $0.8 \ensuremath{_{-0.0}^{+0.5}}$ & $8428 \pm 300$ &$1.9 \ensuremath{_{-0.2}^{+1.7}}$ \\
