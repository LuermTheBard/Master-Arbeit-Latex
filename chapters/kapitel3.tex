...
\end{equation}
This yields the weighted-mean SMBH mass of $\bar{M}_{\mathrm{BH}}\approx (0.9 \pm 0.1)\times 10^{7}\,M_\odot$.
\begin{table}[!ht]
	\centering
	\small
...
Subsequently, the weighted-mean SMBH mass yields $\bar{M}_{\mathrm{BH,corr}} \approx (3.6 \pm 0.5)\times 10^{7}\,M_\odot$.
