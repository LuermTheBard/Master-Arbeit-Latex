...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/lightcurves/NGC4593_Continua_1.pdf}
	...
	\label{fig:continua_lightcurves1}
\end{figure}
\clearpage
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/lightcurves/NGC4593_Continua_2.pdf}
	\caption{Comparison of the continua lightcurves. }
	\label{fig:continua_lightcurves2}
\end{figure}
\clearpage
\begin{figure}[!ht]
	\centering
