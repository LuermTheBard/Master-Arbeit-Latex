...
The mean profiles of the Balmer lines show overall similar shape with a steep slope in their blue wing and asymmetric broader red wing. The latter cannot be seen for the mean profile of H$\gamma$ due to the blending with [O\,\textsc{iii}] $\lambda4363$ in its red wing.\\
...
Ly$\alpha$ shows absorption in the blue wing and is blended with N\,\textsc{v}$\,\lambda\lambda 1283,\,1242$ in the red wing of both the mean and rms profile. 
...
Comparing the rms profiles, they all show a similar shapea much broader blue wing, which results in a broader overall line width. The rms profile of He\,\textsc{ii}$\,\lambda1640$ is less pronounced and blended with the rms profile of the semi-forbidden doublet O\,\textsc{iii}]$\lambda\lambda\,1660,1666$. Still its shape is comparable to the He\,\textsc{ii}$\,\lambda4685$ rms profile shape with no velocity shift and broader blue wing.



\subsubsection{N\,\textsc{V}$\,\lambda\lambda 1283,\,1242$}

The blue wings of mean and rms profile of N\,\textsc{V}$\,\lambda\lambda 1283,\,1242$ are mostly blended with Ly$\alpha$. In addition the rms profile exhibits not resolved absorption in its blue wing in the rms spectrum.

\subsubsection{Si\,\textsc{IV}$\,\lambda\lambda 1393,\,1402$}
Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$ is blended with the semi-forbidden doublet O\textsc{IV}]$\,\lambda\lambda\,1397,\,1400$, which cannot be resolved from the line profile. 
