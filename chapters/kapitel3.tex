...
\begin{table}[!ht]
	...
	\begin{tabular}{l c }
		...
		He\,\textsc{i}\,5875 & $3.3 \ensuremath{_{-0.4}^{+0.7}}$  \\
		He\,\textsc{ii}\,4685 & $0.7 \ensuremath{_{-0.3}^{+0.1}}$ \\
		He\,\textsc{ii}\,1640 & $0.3 \ensuremath{_{-0.2}^{+0.6}}$  \\
		O\,\textsc{i}\,8446 & $5.0 \ensuremath{_{-1.7}^{+2.1}}$ \\
		Si\,\textsc{iv}\,1393 & $1.2 \ensuremath{_{-0.4}^{+0.1}}$  \\
		C\,\textsc{iv}\,1548 & $0.8 \ensuremath{_{-0.0}^{+0.5}}$ \\
		\hline
		\hline
	\end{tabular}
\end{table}
