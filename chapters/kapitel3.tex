...
\begin{table}[!htb] 
	\centering 
	\caption{Variability statistics of the measured continua with minimum flux(2) and maximum flux density or integrated flux (3), peak-to-peak ratio (4), mean (5), standard deviation (6) and fractional variation (7).} 
...
\begin{table}[!htb] 
	\centering 
	\caption{Variability statistics of the measured optical to near-infrared emission lines with minimum flux(2) and maximum flux density or integrated flux (3), peak-to-peak ratio (4), mean (5), standard deviation (6) and fractional variation (7).} 
	\begin{tabular}{lrrrrrr} 
		\hline 
		\hline 
		Continuum/Line &  \multicolumn{1}{c}{$F_{\text{min}}$} &  \multicolumn{1}{c}{$F_{\text{max}}$} &  \multicolumn{1}{c}{$R_{\text{max}}$} &  \multicolumn{1}{c}{$\langle F \rangle$} &  \multicolumn{1}{c}{$\sigma_F$} &  \multicolumn{1}{c}{$F_{\text{var}}$} \\ 
		...
		\hline 
		\hline 
		\label{tab:varstatistics_optical} 
	\end{tabular} 
...
\begin{table}[!htb] 
	\centering 
	\caption{Variability statistics of the measured UV emission lines with minimum flux(2) and maximum flux density or integrated flux (3), peak-to-peak ratio (4), mean (5), standard deviation (6) and fractional variation (7).} 
	\begin{tabular}{lrrrrrr} 
		\hline 
		\hline 
		Continuum/Line &  \multicolumn{1}{c}{$F_{\text{min}}$} &  \multicolumn{1}{c}{$F_{\text{max}}$} &  \multicolumn{1}{c}{$R_{\text{max}}$} &  \multicolumn{1}{c}{$\langle F \rangle$} &  \multicolumn{1}{c}{$\sigma_F$} &  \multicolumn{1}{c}{$F_{\text{var}}$} \\ 
		...
		NV$\,\lambda\lambda 1238,\,1242$ & $18.87$ & $32.7$ & $1.73$ & $24.23$ & $3.54$ & $0.15$ \\
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=1\textwidth]{pictures/Chapter4/lightcurves/NGC4593_UV_Lines_UVW2.pdf}
	\caption{Comparison of the emission-line lightcurves to the UVW2 reference lightcurve in the first panel. The UVW2 lightcurve was obtained from \cite{mchardy2018x}}
...
\begin{table}[h!]
	...
	\begin{tabular}{lcc}
		...
		H$\delta$ & $3104 \pm 210$&  $4893 \pm 300$ \\
		\hline
...
\begin{table}[!htb]
	...
	\begin{tabular}{l c c c}
		...
		\hline
		H$\alpha$ & $3.2 \ensuremath{_{-0.6}^{+1.0}}$ & $2.0 \ensuremath{_{-0.5}^{+3.0}}$ & $1.1 \ensuremath{_{-0.4}^{+0.6}}$ \\
		H$\beta$ & $2.3 \ensuremath{_{-0.3}^{+1.0}}$ & $2.0 \ensuremath{_{-0.1}^{+1.0}}$ & $0.9 \ensuremath{_{-0.2}^{+0.6}}$ \\
		H$\gamma$ & $1.7 \ensuremath{_{-0.4}^{+0.2}}$ & $2.0 \ensuremath{_{-1.0}^{+0.1}}$ & $0.9 \ensuremath{_{-0.3}^{+0.3}}$ \\
		H$\delta$ & $1.7 \ensuremath{_{-0.4}^{+0.4}}$ & $2.0 \ensuremath{_{-1.0}^{+0.1}}$ & $1.5 \ensuremath{_{-0.4}^{+0.6}}$ \\
		He\,\textsc{i}\,5875 & $3.3 \ensuremath{_{-0.4}^{+0.7}}$ & $3.0 \ensuremath{_{-0.1}^{+1.5}}$ & $1.7 \ensuremath{_{-0.4}^{+0.7}}$ \\
		He\,\textsc{ii}\,4685 & $0.7 \ensuremath{_{-0.3}^{+0.1}}$ & $1.0 \ensuremath{_{-0.5}^{+0.0}}$ & $0.9 \ensuremath{_{-0.4}^{+0.2}}$ \\
		O\,\textsc{i}\,8446 & $5.0 \ensuremath{_{-1.7}^{+2.1}}$ & $6.0 \ensuremath{_{-3.0}^{+1.5}}$ & - \\
...
\begin{table}[!htb]
	...
	\begin{tabular}{l c c c}
		...
		Name & $\tau_{\text{cent}}$ [d] & $\tau_{\text{peak}}$ [d] & $M_{\text{BH}} [10^7 M_\odot]$ \\
		\hline
		Ly$\alpha$ & $1.0 \ensuremath{_{-0.2}^{+0.4}}$ & $1.0 \ensuremath{_{-0.5}^{+0.1}}$ & $0.6 \ensuremath{_{-0.1}^{+0.2}}$ \\
		Si\,\textsc{iv}\,1393 & $1.2 \ensuremath{_{-0.4}^{+0.1}}$ & $2.0 \ensuremath{_{-1.0}^{+0.5}}$ & $3.6 \ensuremath{_{-1.2}^{+0.3}}$ \\
		N\,\textsc{v}\,1238 & $1.0 \ensuremath{_{-0.4}^{+0.2}}$ & $1.0 \ensuremath{_{-0.5}^{+0.1}}$ & $0.4 \ensuremath{_{-0.1}^{+0.1}}$ \\
		C\,\textsc{iv}\,1548 & $0.8 \ensuremath{_{-0.0}^{+0.5}}$ & $1.0 \ensuremath{_{-0.5}^{+0.1}}$ & $1.5 \ensuremath{_{-0.0}^{+1.0}}$ \\
		He\,\textsc{ii}\,1640 & $0.3 \ensuremath{_{-0.2}^{+0.6}}$ & - & $0.4 \ensuremath{_{-0.3}^{+1.0}}$ \\
		\hline
		\hline
	\end{tabular}
\end{table}
