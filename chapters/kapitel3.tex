...
Figure \ref{fig:RMS_Balmer} shows a comparison of the RMS line profiles of the Balmer lines. They all show a overall similar asymmetric double-peaked shape which is shifte towards positive velocities. The peaks are located between $\sim 0$--$500\,\mathrm{km\,s^{-1}}$ and between $\sim 1500$--$2000\,\mathrm{km\,s^{-1}}$, showing that most of the flux variation of the Balmer lines appear in the red wing of the Balmer lines. For H$\alpha$, H$\beta$ and H$\gamma$ the first peak showes more flux, then the second peak, while the second peak of H$\delta$ shows a higher flux compared to the first, but is more scattered than for the other Balmer lines.
...
Figure \ref{fig:RMS_Helium} shows the RMS profiles of the He\,\textsc{ii}$\,\lambda1640$, He\,\textsc{ii}$\,\lambda4685$ and He\,\textsc{i}$\,\lambda5875$ as well as a comparison of the He\,\textsc{ii} profiles. First looking at the profile of He\,\textsc{ii}$\,\lambda1640$, it shows a broad blue wing followed by a steep increase towards its maximum. it was mentioned before, that its red flank is blended with the profile of the doublet O\,\textsc{iii}]$\,\lambda\lambda 1660,\,1666$ in at approximately $\sim 1000 \mathrm{km\,s^{-1}}$. But because its overlaying flux lies under  the half height of the profile, it does not influence the measurement of FWHM and allows to compare it to the profile of He\,\textsc{ii}$\,\lambda4685$.
...
and for Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402$ the overlapping doublet components together with additional semi-forbidden O\,\textsc{iv}] emission prevent a reliable FWHM estimate from the RMS spectrum.

\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\textwidth]{pictures/Chapter4/line_profiles/UV_Lines.pdf}
	\caption{UV}
	\label{fig:RMS_UV}
\end{figure}
