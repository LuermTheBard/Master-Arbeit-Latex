...
\begin{equation}
	\sigma_i^\mathrm{inter.cal.} = F_\mathrm{var}^{\mathrm{[O\,\textsc{iii}]}\,\lambda5007} \cdot f_i .
\end{equation}
This yields the total light-curve uncertainty:
\begin{equation}
	\sigma_i = \sqrt{\left(\sigma_i^\mathrm{inter.cal.}\right)^2 + \left(\sigma_{\mathrm{noise}}\right)^2} ,
\end{equation}
...
\begin{table}[h!]
	...
	\begin{tabular}{lcc}
		...
		H$\gamma$ & $4014 \pm 300$&  $3794 \pm 300$ \\
		\hline
		HeI$\,\lambda5875$ & $3369 \pm 300$&  $4245 \pm 300$  \\
		HeII$\,\lambda4685$ &  -&  $5901 \pm 200$ \\
