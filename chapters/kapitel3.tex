...
As mentioned in the previously section, the N\,\textsc{v}$\,\lambda\lambda 1283,\,1242 $ is blended with the Ly$\alpha$ profile in both mean and rms and  exhibits absorption in its blue wing in the rms spectrum and made a reliable FWHM for the N\,\textsc{v}$\,\lambda\lambda 1283,\,1242 $ profiles not possible.\\
The profiles of Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402 $ are blended with the semi-forbidden line doublet O\textsc{IV}]$\,\lambda\lambda\,1397,\,1400$ such that any FWHM measurement would include contributions from both components and cannot be attributed to Si\,\textsc{iv}$\,\lambda\lambda 1393,\,1402 $ alone, and is therefore excluded in the FWHM measurment. \\
The resulting FWHM values are listed in Table \ref{tab:line_width_FWHM}. The uncertainties are estimated primarily from the instrumental dispersion of the respective gratings (see Table \ref{tab:stis_gratings}), and are adjusted accordingly the noise and shape of the profiles.\\ 
