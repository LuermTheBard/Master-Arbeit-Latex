...
Figure \ref{fig:RMS_Balmer} shows a comparison of the RMS line profiles of the Balmer lines. They all show a overall similar asymmetric double-peaked shape, which is red-shifted compared to their AVG profiles. Most parts of the line lies at positive velocities, with the peaks located between $\sim 0$--$500\,\mathrm{km\,s^{-1}}$ and between $\sim 1500$--$2000\,\mathrm{km\,s^{-1}}$. Following that, most of the flux variation of the Balmer lines seems to occurs within positive velocities of the emitting region. For H$\alpha$, H$\beta$ and H$\gamma$ the first peak showes more flux, then the second peak, while the second peak of H$\delta$ shows a higher flux compared to the first, but is more scattered than for the other Balmer lines.
...
Finally, the RMS profile of the C\textsc{iv}$\,\lambda\lambda 1548,\,1550$ doublet shows again a very asymmetric shape, with a fall off of its flux at about $0\,  \mathrm{km\,s^{-1}}$ of about half the heicht of the profile, giving it a double-peak shape.

\textbf{C doublet nochmal besprechen.}
...
\textbf{Describe the selection of the broad lines for the BH estimation. EG FWHM measurement.}
